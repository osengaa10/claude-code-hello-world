...
The Surface Pro 8 brings the power of a PC in a tablet form. Its high-resolution PixelSense display provides excellent visual quality, and unlike the iPad Pro, it includes the Surface Pen. With full Windows 10, you can run full versions of drawing software like Photoshop or Illustrator. However, under heavy usage, you may find its battery life lacking.
...
The Wacom Intuos is a great entry-level drawing tablet. It comes with a pen that doesn't require batteries and can be customized to your liking with four ExpressKeys. However, it falls short in terms of portability and screen. It's reliant on a computer for display, and some may find the drawing area too small on cheaper models.

## Use Cases and Recommendations

For professional artists who need a portable, standalone tablet with top-notch display quality and don't mind the extra cost, the iPad Pro is the best tablet for drawing. However, if you need the versatility of a full OS to run heavy-duty drawing software, the Surface Pro 8 is an excellent choice. 
...
A: For the iPad Pro, you will need to purchase the Apple Pencil separately. The Surface Pro 8 and Wacom Intuos come with their respective stylus pens.

## Conclusion

After an in-depth comparison, the best tablet for drawing depends on your specific needs and budget. The iPad Pro offers the highest quality display and seamless experience, the Surface Pro 8 provides the versatility of a full OS, and the Wacom Intuos delivers affordability and customization. 
