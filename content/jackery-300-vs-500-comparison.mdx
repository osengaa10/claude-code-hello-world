...
| Criteria | Jackery Explorer 300 | Jackery Explorer 500 |
|:---|:---:|:---:|
...
The Jackery Explorer 300 is a compact, lightweight portable power station that boasts a 293Wh lithium-ion battery. It weighs only 7.1 lbs and comes with multiple output ports, making it ideal for powering a variety of devices. 
...
The Jackery Explorer 500, on the other hand, is a beefier model with a lithium-ion battery boasting a 518Wh capacity. It can deliver an AC output of up to 500W, with peak performance reaching 1000W.
