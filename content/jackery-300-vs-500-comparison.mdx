...
## <ProductLink productName="Jackery Explorer 500" asin="B07SM5HBK1">Jackery Explorer 500</ProductLink> Review

The <ProductLink productName="Jackery Explorer 500" asin="B07SM5HBK1">Jackery Explorer 500</ProductLink>, on the other hand, is a beefier model with a lithium-ion battery boasting a 518Wh capacity. It can deliver an AC output of up to 500W, with peak performance reaching 1000W.
...
<div style={{display: "flex", gap: "1rem", flexWrap: "wrap", margin: "2rem 0"}}>
  <AmazonButton productName="Jackery Explorer 300" />
  <AmazonButton productName="Jackery Explorer 500" />
</div>
